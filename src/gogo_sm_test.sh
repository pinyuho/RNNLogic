...
for CLUSTER_SIZE in "${CLUSTER_SIZES[@]}"; do
  ...
  EXP_NAME="${MODEL}_${MULTITASK_LOSS_MODE}_${RELATION_CLUSTER_METHOD}_${CLUSTER_SIZE}"
  echo "▶ Running: ${STAMP}.log"
  LOG_FILE="logs/${STAMP}.log"

  sed -i "s|^save_path: .*|save_path: results/${DATASET}/sm_test/${EXP_NAME}_${STAMP}|" "$CONFIG_PATH"
