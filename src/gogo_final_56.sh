...
for CLUSTER_SIZE in "${CLUSTER_SIZES[@]}"; do
  ...
  sed -i "s|^save_path: .*|save_path: results/${DATASET}/multitask_mmoe/ent_all_types/k${CLUSTER_SIZE}_${EXP_NAME}_${STAMP}|" "$CONFIG_PATH"
  # sed -i "s|^save_path: .*|save_path: results/${DATASET}/sm_test/k${CLUSTER_SIZE}_${STAMP}|" "$CONFIG_PATH" # FIXME:
