...
for CLUSTER_SIZE in "${CLUSTER_SIZES[@]}"; do
  ...
  EXP_NAME="PCA_${MODEL}_${MULTITASK_LOSS_MODE}_${RELATION_CLUSTER_METHOD}_${CLUSTER_SIZE}_${TYPE_OR_GROUP}"
  ...
  if [ "$TYPE_OR_GROUP" == "group" ]; then
    ...
    sed -i "s|relation_cluster_file: .*|relation_cluster_file: ../data/${DATASET}/relation_cluster/pca_5_${RELATION_CLUSTER_METHOD}_${CLUSTER_SIZE}.dict|" "$CONFIG_PATH"
  fi
