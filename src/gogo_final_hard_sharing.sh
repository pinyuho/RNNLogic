...
for CLUSTER_SIZE in "${CLUSTER_SIZES[@]}"; do
  ...
  sed -i "s|^save_path: .*|save_path: results/${DATASET}/multitask_mmoe/ent_all_types/${EXP_NAME}_soft_label_${STAMP}|" "$CONFIG_PATH" # FIXME:
  # sed -i "s|^save_path: .*|save_path: results/${DATASET}/sm_test|" "$CONFIG_PATH" 
